# pawan chauhan 1/11/2025 Building A Calorie Tracking console Application
...
for i in range(number_of_meals): 
    ...
    meals.append(meal) # adding meal name 
    calories.append(calorie) # adding calorie intake 
total_calories=sum(calories) #  total calorie intake
